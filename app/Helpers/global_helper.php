...
function set_list_award($isi)
{
    ...
    $isi = str_replace("<i>", '<li><span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>', $isi);
    return $isi;
}
...
{
    $isi = str_replace("<ul>", '<ul class="fa-ul mb-0">', $isi);
    $isi = str_replace("<i>", '<li><span class="fa-li"><i class="fas fa-check"></i></span>', $isi);
    return $isi;
}